    ...
    return (
      <div
        className={cn(
          ...
          invalid
            ? 'border-red-500'
            : 'border-gray-300 focus-within:border-[#1F5D8F] focus-within:ring-1 focus-within:ring-[#1F5D8F]/30',
          className,
        )}
      >
        ...
        <input
          ...
          className="w-full bg-transparent py-2 pr-3 text-right outline-none"
          {...rest}
        />
      </div>
    )
