...
export default async function LoanOfficerConditionsPage() {
  ...
  // Get all conditions assigned to loan_officer across these loans
                  ...
                  {group.items.map(condition => (
                    <div key={condition.id} className="py-3 flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <Link
                          href={`/loan-officer/loans/${condition.loan_id}`}
