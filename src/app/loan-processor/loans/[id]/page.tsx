          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <FieldRow label="Origination Date">
                <EditableLoanField loanId={loan.id} field="origination_date" type="date" currentValue={loan.origination_date} display={formatDate(loan.origination_date)} />
              </FieldRow>
              <FieldRow label="Maturity Date">
                <EditableLoanField loanId={loan.id} field="maturity_date" type="date" currentValue={loan.maturity_date} display={formatDate(loan.maturity_date)} />
              </FieldRow>
