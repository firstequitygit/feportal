...
export function Wizard({ initialData, initialStep, initialToken, isAdmin = false, loanOfficerOptions, variantKind = 'borrower', authenticated = false }: {
  ...
  const stepEl = [
    <Step1Borrower key={1} data={data} set={set} ensureDraft={ensureDraft} missingFields={liveMissing} loanOfficerOptions={loanOfficerOptions} primaryExtraFields={variant.fieldArrays.primaryExtraFields} brokerInfoFields={variant.fieldArrays.brokerInfoFields} readOnlyPrimaryFields={authenticated ? ['email'] : undefined} />,
