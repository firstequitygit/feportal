...
// NOTE: Declaration and HMDA fields are now stored at the root of `data`
// (e.g., data.d_liens, data.hmda_ethnicity), not per-borrower. Production phrases
// declarations as "you (borrower or co-borrower)" — one set applies to the whole
// application. HMDA is for the primary borrower only.
// In-flight drafts saved before this change will read empty declaration/HMDA values —
// acceptable; borrowers can re-enter.
  ...
  return (
    <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6">
      ...
      <p className="text-sm text-gray-600">
        Printed name: <strong className="text-gray-900">{printed || '—'}</strong>
    ...
    <div className="space-y-10">
      ...
      <section>
        ...
        <p className="mb-6 text-sm text-gray-500 leading-relaxed">
          ...
          They do not affect your application. You may choose &ldquo;I do not wish to provide this information.&rdquo;
        </p>
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <FieldRenderer
            fields={HMDA_FIELDS}
      ...
      <section>
        <h3 className="mb-4 text-base font-semibold text-gray-900">Authorization &amp; signature</h3>
