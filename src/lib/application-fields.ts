...
export const BORROWER_FIELDS: FieldDef[] = [
  { name: 'first_name', label: 'First Name', type: 'text', required: true, section: 'About you' },
  { name: 'middle_name', label: 'Middle Name', type: 'text', section: 'About you' },
  { name: 'last_name', label: 'Last Name', type: 'text', required: true, section: 'About you' },
  ...
  { name: 'email', label: 'Email', type: 'email', required: true, section: 'Contact information' },
  { name: 'cell_phone', label: 'Cell Phone', type: 'tel', required: true, section: 'Contact information' },
  { name: 'other_phone', label: 'Other Phone', type: 'tel', section: 'Contact information' },
  ...
  { name: 'address_street', label: 'Address Line 1', type: 'text', required: true, section: 'Current address' },
  { name: 'address_city', label: 'City', type: 'text', required: true, section: 'Current address' },
  { name: 'address_state', label: 'State', type: 'text', required: true, section: 'Current address' },
  { name: 'address_zip', label: 'Zip Code', type: 'text', required: true, section: 'Current address' },
...
export const DEAL_FIELDS: FieldDef[] = [
  ...
  { name: 'property_street', label: 'Property Address Line 1', type: 'text', required: true, section: 'Property' },
  { name: 'property_city', label: 'City', type: 'text', required: true, section: 'Property' },
  { name: 'property_state', label: 'State', type: 'text', required: true, section: 'Property' },
  { name: 'property_zip', label: 'Zip Code', type: 'text', required: true, section: 'Property' },
  ...
  { name: 'broker_name', label: "Broker's Name", type: 'text', section: 'Mortgage broker',
    visibleWhen: (d) => d.has_broker === true },
  { name: 'broker_email', label: "Broker's Email", type: 'email', section: 'Mortgage broker',
    visibleWhen: (d) => d.has_broker === true },
  { name: 'broker_phone', label: "Broker's Phone", type: 'tel', visibleWhen: (d) => d.has_broker === true, section: 'Mortgage broker' },
  { name: 'broker_fee', label: 'Broker Fee', type: 'text', visibleWhen: (d) => d.has_broker === true, section: 'Mortgage broker' },
  { name: 'has_title_vendor', label: 'Do you have a preferred vendor for title insurance?', type: 'yesno', section: 'Title vendor' },
  { name: 'title_company', label: 'Title Company Name', type: 'text', section: 'Title vendor',
    visibleWhen: (d) => d.has_title_vendor === true },
  { name: 'title_contact_name', label: 'Title Contact Name', type: 'text', visibleWhen: (d) => d.has_title_vendor === true, section: 'Title vendor' },
  { name: 'title_contact_email', label: 'Title Contact Email', type: 'email', section: 'Title vendor',
    visibleWhen: (d) => d.has_title_vendor === true },
  { name: 'title_contact_phone', label: 'Title Contact Phone', type: 'tel', visibleWhen: (d) => d.has_title_vendor === true, section: 'Title vendor' },
  ...
  { name: 'insurance_company', label: 'Insurance Company Name', type: 'text', section: 'Insurance vendor',
    visibleWhen: (d) => d.has_insurance_vendor === true },
  { name: 'insurance_contact_name', label: 'Insurance Contact Name', type: 'text', visibleWhen: (d) => d.has_insurance_vendor === true, section: 'Insurance vendor' },
  { name: 'insurance_contact_email', label: 'Insurance Contact Email', type: 'email', section: 'Insurance vendor',
    visibleWhen: (d) => d.has_insurance_vendor === true },
  { name: 'insurance_contact_phone', label: 'Insurance Contact Phone', type: 'tel', visibleWhen: (d) => d.has_insurance_vendor === true, section: 'Insurance vendor' },
...
export const PRIMARY_EXTRA_FIELDS: FieldDef[] = [
  ...
  { name: 'entity_name', label: 'Entity Name', type: 'text', section: 'Entity (if applicable)' },
