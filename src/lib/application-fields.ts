...
export const DEAL_FIELDS: FieldDef[] = [
  ...
  { name: 'current_loan_balance', label: 'Current Loan Balance', type: 'currency', visibleWhen: isRefi, requiredWhen: isRefi },
  ...
  { name: 'exit_strategy', label: 'Exit Strategy', type: 'select', options: EXIT_STRATEGY_OPTIONS, visibleWhen: isBridge, requiredWhen: isBridge },
  ...
  { name: 'broker_name', label: "Broker's Name", type: 'text',
    visibleWhen: (d) => d.has_broker === true, requiredWhen: (d) => d.has_broker === true },
  { name: 'broker_email', label: "Broker's Email", type: 'email',
    visibleWhen: (d) => d.has_broker === true, requiredWhen: (d) => d.has_broker === true },
  ...
  { name: 'title_company', label: 'Title Company Name', type: 'text',
    visibleWhen: (d) => d.has_title_vendor === true, requiredWhen: (d) => d.has_title_vendor === true },
  { name: 'title_contact_name', label: 'Title Contact Name', type: 'text', visibleWhen: (d) => d.has_title_vendor === true },
  { name: 'title_contact_email', label: 'Title Contact Email', type: 'email',
    visibleWhen: (d) => d.has_title_vendor === true, requiredWhen: (d) => d.has_title_vendor === true },
  ...
  { name: 'insurance_company', label: 'Insurance Company Name', type: 'text',
    visibleWhen: (d) => d.has_insurance_vendor === true, requiredWhen: (d) => d.has_insurance_vendor === true },
  { name: 'insurance_contact_name', label: 'Insurance Contact Name', type: 'text', visibleWhen: (d) => d.has_insurance_vendor === true },
  { name: 'insurance_contact_email', label: 'Insurance Contact Email', type: 'email',
    visibleWhen: (d) => d.has_insurance_vendor === true, requiredWhen: (d) => d.has_insurance_vendor === true },
